    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="flex flex-col justify-center cursor-pointer items-center w-9 h-9 rounded-lg border border-[#2e2e2e]
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-[#2a2a2a]">
          ...
          <button
            onClick={() => setOpen(false)}
            className="w-8 h-8 rounded-lg border cursor-pointer border-[#2e2e2e] flex items-center justify-center
