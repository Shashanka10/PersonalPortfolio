        ...
        <div className="relative z-10 space-y-10 max-w-7xl">
          <div className={`${fade(v0)} space-y-3`}>
            ...
            <p className="text-gray-500 text-xs sm:text-sm leading-relaxed">
              Whether it's a work opportunity or just a hello, feel free to
              contact me.
            </p>
          </div>
            ...
            <Reveal>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-5 rounded-2xl bg-[#1e2e22] border border-[#12c971]/20">
                ...
                <button
                  ...
                  className={`flex items-center cursor-pointer justify-center gap-2.5 px-5 py-2.5 rounded-xl font-semibold text-sm border transition-all duration-300 shrink-0
            ...
            <div className="space-y-4">
              ...
              <form ref={form} onSubmit={sendEmail} className="space-y-4">
                ...
                <button
                  ...
                  className={`w-full flex items-center cursor-pointer justify-center gap-3 py-3.5 rounded-xl font-bold text-sm tracking-wide transition-all duration-300
