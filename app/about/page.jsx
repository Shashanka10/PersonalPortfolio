...
function TabPill({ active, onClick, icon, label }) {
  return (
    <button
      onClick={onClick}
      className={`flex items-center cursor-pointer gap-2 px-4 py-2 rounded-full text-sm font-semibold border transition-all duration-300
...
function TimelineEntry({ date, title, subtitle, children }) {
  return (
    <div className="relative pl-6 border-l border-[#5f5f5f] hover:border-[#12c971]/50 transition-colors duration-500">
      ...
      <h3 className="text-gray-100 text-base sm:text-lg md:text-xl font-bold">
        {title}
      </h3>
...
const About = () => {
  ...
  const tools = [
    ...
    { icon: <TbBrandVisualStudio />, label: "VS Code" },
          ...
          <Reveal>
            <div className="flex flex-col lg:flex-row lg:items-start md:justify-between gap-8 pt-6 md:pt-0">
              ...
              <div className="flex flex-wrap flex-row min-w-full lg:flex-col gap-4 lg:min-w-[220px]">
                <button
                  className={`flex-1 md:flex-none flex items-center cursor-pointer justify-center gap-3 px-2 py-2.5 md:px-5 md:py-3 rounded-lg md:rounded-xl font-semibold text-xs md:text-sm border-2 transition-all duration-300
                ...
                >
                  <button className="w-full flex items-center cursor-pointer justify-center gap-3 px-2 py-2.5 md:px-5 md:py-3 rounded-lg md:rounded-xl font-semibold text-xs md:text-sm text-gray-100 bg-[#222] border border-[#2e2e2e] hover:bg-[#2a2a2a] hover:border-[#12c971]/40 transition-all duration-300">
